...
module.exports = {
    live : function (options) {
        ...
        if (options.pusher || options.pusherChannel) {
            ...
            if (options.channelType === "private" || options.channelType === "presence") this.channelType = options.channelType + "-";

            this.log = options.log || false;
            if (this.log) { Pusher.log = function (message) {
        ...
        if (this.liveType === "pusher") {
            ...
            var update = _.bind(function () {  
                ...
                // Make a shallow copy of the options object.
                  // `Ampersand.collection.fetch` wraps the success function
